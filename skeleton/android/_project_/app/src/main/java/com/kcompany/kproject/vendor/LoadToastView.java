package com.kcompany.kproject.vendor;
...
public class LoadToastView extends View {
    ...
    private int BASE_TEXT_SIZE = 16;//20
    private int IMAGE_WIDTH = 30;//40
    private int TOAST_HEIGHT = 38;//48
    ...
    public LoadToastView(Context context) {
        ...
        completeicon = getResources().getDrawable(R.mipmap.ic_navigation_check);
        completeicon.setBounds(iconBounds);
        failedicon = getResources().getDrawable(R.mipmap.ic_error);
